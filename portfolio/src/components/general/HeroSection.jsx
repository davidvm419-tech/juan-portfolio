...
export default function HeroSection() {
    ...
    return (
        <div className="relative h-screen bg-[#1A1A1F] overflow-hidden flex items-center justify-center px-6">
            <div className="absolute top-1/4 left-1/2 w-[800px] h-[800px] blur-[120px] rounded-full bg-[#0d262b] 
                animate-[colorCycle_12s_ease-in-out_infinite] pointer-events-none"/>

            <div className="absolute inset-0 bg-gradient-to-b from-[#1A1A1F]/40 to-transparent"/>
            ...
            <div className="relative text-center max-w-3xl">
                ...
                <button className="mt-10 px-8 py-3 rounded-lg text-white border
                    animate-[buttonCycle_4s_ease-in-out_infinite] hover:scale-105 transition-all duration-300"
